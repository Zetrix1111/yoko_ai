"""
api/aprobaciones.py
Endpoint del módulo "Aprobaciones".
Stub inicial: recibe JSON, valida DNI, responde OK.
TODO: reemplazar el eco por lógica real (Make/Airtable/Anthropic).
"""
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        try:
            ...
            # TODO: conectar con Make / Airtable / Anthropic
